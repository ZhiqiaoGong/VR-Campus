	...
	public class MediaPlayerEditor : UnityEditor.Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			{ 
                ...
                //Debug.Log(media.m_VideoPath);

                //LgGraphOutput l = GameObject.GetGameObject("LgGraph").GetComponent<LgGraphOutput>();

                //media.m_VideoPath= "E:/校园漫游视频/2_3.mp4";
		...
		private void OnInspectorGUI_PlayControls(IMediaControl control, IMediaInfo info)
		{
			...
			if (control != null)
			{
				currentTime = control.GetCurrentTimeMs();//获取当前时间
			}
			...
			if (newTime != currentTime)
			{
                ...
                Debug.Log(newTime);
                control.Seek(newTime); //这句话控制滑动条查找新的帧
            }
